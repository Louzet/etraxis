...
/**
 * @covers \eTraxis\Controller\API\ApiIssuesController::createFile
 */
class CreateFileTest extends TransactionalTestCase
{
    ...
    public function testSuccess()
    {
        ...
        $files = count($repository->findAllByIssue($issue));
        ...
        self::assertTrue($response->isRedirect("http://localhost/api/files/{$file->id}"));

        self::assertCount($files + 1, $repository->findAllByIssue($issue));
    }
