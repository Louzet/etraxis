...
class FieldType extends StaticDictionary
{
    ...
    /**
     * Returns class name of CreateField command which corresponds to specified field type.
     *
    ...
    /**
     * Returns class name of UpdateField command which corresponds to specified field type.
     *
     * @param null|string $type
     *
     * @return null|string
