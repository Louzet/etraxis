...
{
    /**
     * Returns admin actions available for specified template.
     *
     * @Route("/actions/{id}", name="admin_template_actions", methods={"GET"}, requirements={"id": "\d+"})
     *
     * @param Template $template
     *
     * @return JsonResponse
     */
    public function actions(Template $template): JsonResponse
    {
        return $this->json([
