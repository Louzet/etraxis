 ...
 * @covers \eTraxis\CommandBus\CommandHandler\Issues\CloneIssueHandler::handle
 */
class CloneIssueCommandTest extends TransactionalTestCase
{
    ...
    public function testFailedWithResponsible()
    {
        ...
        $this->expectExceptionMessage('Validation failed for eTraxis\CommandBus\Command\Issues\CloneIssueCommand with 1 violation(s).');
