...
/**
 * @covers \eTraxis\CommandBus\CommandHandler\Issues\AbstractIssueHandler::validateState
 * @covers \eTraxis\CommandBus\CommandHandler\Issues\ChangeStateHandler::handle
 */
class ChangeStateCommandTest extends TransactionalTestCase
{
    ...
    public function testValidationRequiredFields()
    {
        ...
        $this->expectExceptionMessage('Validation failed for eTraxis\CommandBus\Command\Issues\ChangeStateCommand with 2 violation(s).');
    ...
    {
        $this->expectException(InvalidCommandException::class);
        $this->expectExceptionMessage('Validation failed for eTraxis\CommandBus\Command\Issues\ChangeStateCommand with 1 violation(s).');
