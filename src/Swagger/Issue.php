...
class Issue
{
    ...
    /**
     * @API\Property(type="object", ref=@Model(type=eTraxis\Swagger\UserInfo::class), description="Author of the issue.")
     */
    public $author;

    /**
     * @API\Property(type="object", ref=@Model(type=eTraxis\Swagger\State::class), description="Current state.")
     */
    public $state;

    /**
     * @API\Property(type="object", ref=@Model(type=eTraxis\Swagger\UserInfo::class), description="Current responsible of the issue.")
     */
    public $responsible;
