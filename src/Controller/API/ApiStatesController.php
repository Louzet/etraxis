...
use eTraxis\CommandBus\Command\States as Command;
...
class ApiStatesController extends AbstractController
{
     ...
     *             ref=@Model(type=eTraxis\Swagger\State::class)
     *         ))
     *     }
     * ))
     ...
     *             ref=@Model(type=eTraxis\Swagger\StateRoleTransition::class)
     *         )),
     *         @API\Property(property="groups", type="array", @API\Items(
     *             ref=@Model(type=eTraxis\Swagger\StateGroupTransition::class)
     *         ))
     *     }
     * ))
     * @API\Response(response=401, description="Client is not authenticated.")
