 ...
 * @property {Array<Object>} filters Current values of the column filters ([{ "column name": "string value" }]).
 * @property {Array<Object>} sorting Current sort modes ([{ "column name": "asc"|"desc" }]).
 */
