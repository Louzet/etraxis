...
/**
 * @covers \eTraxis\CommandBus\CommandHandler\Issues\UpdateIssueHandler::handle
 */
class UpdateIssueCommandTest extends TransactionalTestCase
{
    ...
    public function testValidationRequiredFields()
    {
        ...
        $this->expectExceptionMessage('Validation failed for eTraxis\CommandBus\Command\Issues\UpdateIssueCommand with 3 violation(s).');
    ...
    {
        $this->expectException(InvalidCommandException::class);
        $this->expectExceptionMessage('Validation failed for eTraxis\CommandBus\Command\Issues\UpdateIssueCommand with 1 violation(s).');
    ...
    {
        $this->expectException(InvalidCommandException::class);
        $this->expectExceptionMessage('Validation failed for eTraxis\CommandBus\Command\Issues\UpdateIssueCommand with 2 violation(s).');
