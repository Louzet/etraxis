 ...
 * @covers \eTraxis\CommandBus\CommandHandler\Issues\CreateIssueHandler::handle
 */
class CreateIssueCommandTest extends TransactionalTestCase
{
    ...
    public function testFailedWithResponsible()
    {
        ...
        $this->expectExceptionMessage('Validation failed for eTraxis\CommandBus\Command\Issues\CreateIssueCommand with 1 violation(s).');
